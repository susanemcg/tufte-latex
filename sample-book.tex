...
\end{enumerate}\marginnote{For more on formatting lists in \LaTeX{}, see \href{https://en.wikibooks.org/wiki/LaTeX/List_Structures}{``List Structures''}.\cite{LaTeXLists}}
